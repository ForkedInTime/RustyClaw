...
Aider and Cursor solved this years ago with a tight loop: lint + test after
...
why did my code disappear?" surprise that makes Aider users love Aider — it
...
appended to the conversation. This matches Aider/Cursor and reads naturally
...
ecosystems. Aider learned this the hard way. The "explain why before
...
3. README gets a short paragraph under "Our Advantages Over Claurst" —
   this is a competitive differentiator (claurst has no auto-fix loop).
